...
MCP, the space is derived from the URL the MCP server is served from:
`/api/agent_builder/mcp` is the default space and
`/s/{spaceId}/api/agent_builder/mcp` selects another space.
